...
# INSERT INTO "metallioApp_universitas"(nama_univ', 'kota) VALUES
...
# ('Akademi Komunitas Negeri (AKN)', 'Aceh Barat Daya'),
# ('STAIN Gajah Putih', 'Takengon'),
# ('IAIN Langsa', 'Langsa'),
# ('STAIN Malikussaleh', 'Lhokseumawe'),
# ('STAIN Gajah Putih Takengon', 'Takengon'),
# ('STAIN Teungku Dirundeng', 'Melabuh'),
...
# ('Poltekes Depkes Medan', 'Medan'),
# ('STAIN Padang Sidempuan', 'Padang Sidempuan'),
# ('UIN Sumatera Utara', 'Medan'),
# ('IAIN Padang Sidempuan', 'Tapanuli Selatan'),
...
# ('UIN Sultan Syarif Kasim (SUSKA)', 'Pekanbaru'),
# ('Politeknik Negeri Bengkalis'),
# ('Universitas Maritim Raja Ali Haji'),
# ('Politeknik Negeri Batam'),
# ('UIN Sultan Syarif Kasim', 'Riau'),
# ('STAIN Bengkalis', 'Riau (Riau)'),
...
# ('STIM (Sekolah Tinggi Olahraga Metro)', 'Kota Metro'),
...
# ('Poltekkes Kemenkes Pangkal Pinang', 'Bangka Belitung'),
...
# ('Akademi Meteorologi dan Geofisika (AMG) Tangerang'),
...
# ('UIN Syarif Hidayatullah Jakartaâ€Ž'),
...
# ('niversitas Singaperbangsa (UNSIKA)', 'Kampus Daerah Karawang'),
# ('Universitas Swadaya Gunung Jati (Unswagati) di Kota Cirebon'),
...
# ('Akademi Ilmu Pemasyarakatan (AKIP)', 'Depok'),
# ('Akademi Imigrasi (AIM) Depok'),
# ('Akademi Kimia Analis (AKA) Bogor'),
# ('Sekolah Tinggi Ilmu Administrasi', 'Bandung'),
# ('Sekolah Tinggi Sandi Negara (STSN)', 'Bogor'),
...
# ('Sekolah Tinggi Pemerintahan Dalam Negeri (STPDN)', 'Sumedang'),
...
# ('Universitas Negeri Surakarta Sebelas Maret', 'Surakarta'),
...
# ('Akademi Militer (AKMIL) TNI AD', 'Magelang'),
# ('Akademi Minyak dan Gas Bumi (AKAMIGAS)', 'Blora'),
# ('Akademi Sanitasi dan Kesehatan Lingkungan (ASKK)', 'Purwokerto'),
...
# ('Universita Terbuka  UPBJJ Yogyakarta'),
...
# ('Sekolah Tinggi Teknologi Nuklir (STTN)', 'Yogyakarta'),
...
# ('STAIN Pamekasan', 'Pamekasan'),
# ('Akademi Angkatan Laut (AAL)', 'Surabaya'),
# ('Teknik Keselamatan Penerbangan (ATKP) Surabaya'),
...
# ('Akademi TKP â€“ Surabaya '),
# ('Universitas Mataram', 'Mataram'),
# ('IAIN Mataram', 'Lombok'),
# ('Sekolah Tinggi Agama Hindu Negeri (STAHN) Gde Puja', 'Mataram'),
...
# ('Sekolah Tinggi Agama Kristen Negeri (STAKN) Denpasar'),
...
# ('IAIN Pontianak sebelumnya STAIN Pontianak'),
# ('Universitas Palangka Raya', 'Palangka Raya'),
# ('IAIN Palangkaraya', 'Palangkaraya'),
# ('Sekolah Tinggi Agama Hindu Negeri Tampung Peyang', 'Palangka Raya'),
...
# ('Ooliteknik Pertanian Negeri Samarinda'),
...
# ('Sekolah Tinggi Ilmu Ekonomi (YPP Mujahidin)', 'Tolitoli'),
# ('IAIN Dato Karamau', 'Palu'),
...
# ('STAIN Parepare', 'Parepare'),
# ('IAIN Palopo', 'Palopo'),
# ('Akademi Teknik Keselamatan Penerbangan (ATKP) Makasar'),
# ('Sekolah Tinggi Ilmu Adm', 'Ujung Pandang'),
...
# ('Sekolah Tinggi. Agama Kristen Negeri (STAKN) Jayapura'),
